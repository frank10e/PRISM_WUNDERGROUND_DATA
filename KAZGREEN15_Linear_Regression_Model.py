...
combined_data = pd.read_csv(r'C:/Users/User/OneDrive/桌面/Wunderground Data/comparison_KAZGREEN15.csv')
...
# Apply the condition: If both ppt_prism and precipTotal are zero, set prediction to zero
corrected_prism = np.where((combined_data['ppt_prism'] == 0) & (combined_data['precipTotal'] == 0), 0, corrected_prism)

# Add the corrected PRISM data to the dataset
combined_data['corrected_prism'] = corrected_prism

# Save the corrected dataset
combined_data.to_csv(r'C:\Users\User\OneDrive\桌面\Wunderground Data\corrected_prism_wunderground_KAZGREEN15_data.csv', index=False)
